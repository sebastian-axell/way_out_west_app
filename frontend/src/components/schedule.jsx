    ...
    return (
        <div className="mt-24 mb2 md:mb-5 ">
            <div className="flex flex-col h-full justify-start items-center w-11/12 xl:w-11/12 3xl:w-7/12 mx-auto mx-auto">
                ...
                <button onClick={() => { setActiveDay("all"); }} className="text-xl px-2 py-1 rounded-lg rounded-b-none border-2 border-b-0 font-bold border-black bg-yellow-300">expand all</button>
