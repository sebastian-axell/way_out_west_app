...
function KeenOption({
    ...
    return (
        <li>
            ...
            <label for={idTag} className={`h-full inline-flex items-center justify-center w-fit p-1 md:p-2 bg-white border-2 text-gray-800 border-gray-400 rounded-lg cursor-pointer hover:text-gray-600 hover:bg-gray-100 ${buttonStyle}`}>                           
                <div class="">
