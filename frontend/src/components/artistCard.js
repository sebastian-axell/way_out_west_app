                    ...
                    <div class="mb-3 font-normal text-gray-700 flex flex-col">
                        <div class="flex start" id="peeps">
                            <div class="flex items-center">      
                                <svg class="w-4 h-4 md:w-7 m:h-7 lg:w-7 lg:h-7 text-green-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="w-full flex justify-center lg:h-10 h-8 overflow-x-hidden">
                                {keenData ?
                                <div className="flex w-full grid grid-cols-2 md:w-10/12 place-items-center gap-y-1 lg:grid-cols-3 justify-around pt-1 md:pt-1 lg:pt-">
